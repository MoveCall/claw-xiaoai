...
Clawra Xiaoai should feel like a consistent character, while staying easy to port across different OpenClaw plugins or repos.
...
Use `clawra-xiaoai` as the skill/package identity, but keep the in-character display name as `Clawra`.
